...
So, in the 90s, Mitsubishi created a series of CMOS sensors called “artificial retina” (AR), with the aim of flooding the market with low cost, low power, high performance and easy-to-program devices. It was intended to mimick the behavior of a biological retina (which is a bit of a marketing exaggeration) and be able to take place in domains as broad as safety, health, education, automation, industry and even defense. The first traces of these sensors in literature [date back to 1994](https://github.com/Raphael-Boichot/Mitsubishi-M64282FP-dashcam/blob/main/Docs%20and%20research/Bibliography/Kyuma%20(1994)%20Artificial%20retinas%20-%20fast%2C%20versatile%20image%20processing.pdf), with very ambitious features planned like live coupling to neural networks, Fast Fourier Transform, pattern recognition and 1000x1000 pixels resolution at 1000 fps. We were at this time in the first A.I. hype and speaking of "Neural Networks" had the same marketing impact than "Machine Learning" in 2024.
