...
CMOS ([Complementary Metal-oxide Semiconductor](https://en.wikipedia.org/wiki/CMOS)) is a quite old technology used in microelectronics to produce logic gates and memories. By chance, these logic gates are more or less sensitive to visible light. The first commercial digital camera, the [Cromemco Cyclops](https://en.wikipedia.org/wiki/Cromemco_Cyclops) made in 1975, was created by hacking a MOS ram chip with a transparent window. The development of image sensors based on CMOS technology for commercial application however only began in the early 90s, in the US, at the [Jet Propulsion Laboratory in NASA](https://spinoff.nasa.gov/Spinoff2017/cg_1.html).

Mitsubishi on their side created their own series of CMOS sensors called “artificial retina” (AR), with the aim of flooding the market with low cost, low power, high performance and easy-to-program devices. These sensors were marketed as mimicking the behavior of a biological retina (concept probably inspired by this [American Scientist](https://github.com/Raphael-Boichot/Mitsubishi-M64282FP-dashcam/blob/main/Docs%20and%20research/Bibliography/Mahowald%20(1991)%20The%20Silicon%20Retina.pdf) article from 1991) and be able to take place in domains as broad as safety, health, education, automation, industry and even defense. The first traces of these sensors in Mitsubishi communication [date back to 1994](https://github.com/Raphael-Boichot/Mitsubishi-M64282FP-dashcam/blob/main/Docs%20and%20research/Bibliography/Kyuma%20(1994)%20Artificial%20retinas%20-%20fast%2C%20versatile%20image%20processing.pdf), with features planned like live coupling to neural networks, Fast Fourier Transform, pattern recognition and 1000x1000 pixels resolution at 1000 fps. What I would summarize as a quite ambitious roadmap. We were at this time in the first A.I. hype and "neural networks" in 1994 were the premises of what we call "machine learning" in 2024. You'd better be in to get juicy grants. And they were in.
