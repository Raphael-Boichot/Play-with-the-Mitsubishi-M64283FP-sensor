...
CMOS ([Complementary Metal-oxide Semiconductor](https://en.wikipedia.org/wiki/CMOS)) is a quite old technology used in microelectronics to produce logic gates and by extension, memories and light sensitive elements. The first commercial solid state camera, the [Cromemco Cyclops](https://en.wikipedia.org/wiki/Cromemco_Cyclops) issued in 1975, was created with a light [sensitive MOS chip](/Pictures%20and%20datasheets/Popular%20Electronics-1975-02.pdf) comprising 32x32 pixels. The development of CMOS-based image sensors for commercial applications however only began in the early 90s, impulsed by the [NASA Jet Propulsion Laboratory](https://spinoff.nasa.gov/Spinoff2017/cg_1.html), with the aim of competiting with the more expensive CCD technology that was the reference at the time.
