...
## I'm a nerd, where can I find one ?!
...
Other source is of course the quite elusive PDZ43 Lapochée camera module which appears sometimes on local auctions as electronic junk, for cheap. As the sensor is solid, this can be reliable source. I got one in 2025 like this.

In brief, to get some, be patient (and a bit lucky).
