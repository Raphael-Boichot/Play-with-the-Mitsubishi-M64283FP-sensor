...
The very first commercial "solid state camera", the [Cromemco Cyclops](https://en.wikipedia.org/wiki/Cromemco_Cyclops), was issued in 1975 equipped with a [32x32 pixels MOS image sensor](/Pictures%20and%20datasheets/Popular%20Electronics-1975-02.pdf) tinkered from a [1024 bits memory chip](http://wsudbrink.dyndns.org:8080/cyclops/index.html) equipped with a transparent windows instead of its usual metal protecting lid. The Charge Coupled Device or [CCD technology](https://en.wikipedia.org/wiki/Charge-coupled_device) then took the lead of the 80s digital photography niche (mainly for high end scientific imaging). CCD sensors were power hungry and expensive but able to produce images with a good signal to noise ratio. This hasn't stopped tinkerers from [continuing to play](/Pictures%20and%20datasheets/BYTE%20(1983)%20Build%20the%20Micro%20D-Cam%20Solid-State%20Video%20Camera.pdf) with modified ram chips as alternatives to expensive CCD sensors. On the other hand, the Complementary Metal–Oxide–Semiconductor or [CMOS technology](https://en.wikipedia.org/wiki/Active-pixel_sensor), alternative image sensing technology easier to integrate into processor production lines, was relegated to the background due to sensors plagued with critical image artifacts, despite being much cheaper. The development of CMOS-based image sensors for viable commercial applications only began in the early 90s, impulsed by the [NASA Jet Propulsion Laboratory](https://spinoff.nasa.gov/Spinoff2017/cg_1.html), with the aim of attacking the thirsty low end market with cheap and very low consumption sensors with tolerable image quality.
