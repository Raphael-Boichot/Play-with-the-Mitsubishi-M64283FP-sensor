...
Some sensors from that series come in K (industrial, ceramic) as well as FP (home, plastic) packaging. No [clear image](/Pictures%20and%20datasheets/RGB%20sensor.png) of the M64283K or specific datasheet exists online (it is just mentioned as possible package in the M64283FP datasheet). Package dimensions are unknown, but probably similar to the [M64285K](https://github.com/Raphael-Boichot/Mitsubishi-M64282FP-dashcam/blob/main/Docs%20and%20research/Bibliography/Mitsubishi%20Integrated%20Circuit%20M64285K%20Image%20Sensor.PDF) to ensure hardware back compatibility. As industrial products have completely separated and even more obscure markets, it is not excluded that they were common in industry at some point without letting a single trace today.
