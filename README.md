...
The first commercial "solid state camera", the [Cromemco Cyclops](https://en.wikipedia.org/wiki/Cromemco_Cyclops) issued in 1975, was created with the [first affordable MOS image sensor](/Pictures%20and%20datasheets/Popular%20Electronics-1975-02.pdf) comprising 32x32 pixels only. Digital sensors then progressively gained in quality and definition and the Charge Coupled Device or [CCD technology](https://en.wikipedia.org/wiki/Charge-coupled_device), with power hungry and expensive sensors producing good quality images, took the lead of the niche 80s digital photography market (mainly high end scientific imaging). On the other hand, the Complementary Metal–Oxide–Semiconductor or [CMOS technology](https://en.wikipedia.org/wiki/CMOS), with sensors plagued with image artifacts, was relegated to the background. The development of CMOS-based image sensors for commercial applications only began in the early 90s, impulsed by the [NASA Jet Propulsion Laboratory](https://spinoff.nasa.gov/Spinoff2017/cg_1.html), with the aim of attacking the low end market with cheap and low consumption sensors.
