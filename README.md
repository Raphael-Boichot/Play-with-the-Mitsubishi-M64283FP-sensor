...
The very first commercial "solid state camera", the [Cromemco Cyclops](https://en.wikipedia.org/wiki/Cromemco_Cyclops), was issued in 1975 equipped with a [32x32 pixels MOS image sensor](/Pictures%20and%20datasheets/Popular%20Electronics-1975-02.pdf) tinkered from a 1024 bits memory chip with a transparent lid (or just the metal lid removed). From this early archaic design, digital image sensors progressively improved in terms of image quality and resolution. The Charge Coupled Device or [CCD technology](https://en.wikipedia.org/wiki/Charge-coupled_device) took the lead of the 80s digital photography niche (mainly for high end scientific imaging). CCD sensors were considered as power hungry and expensive but able to produce images with a good signal to noise ratio. On the other hand, the Complementary Metal–Oxide–Semiconductor or [CMOS technology](https://en.wikipedia.org/wiki/CMOS), alternative basically derived from the microcontroller production lines, was relegated to the background due to sensors plagued with critical image artifacts, despite being much cheaper. The development of CMOS-based image sensors for viable commercial applications only began in the early 90s, impulsed by the [NASA Jet Propulsion Laboratory](https://spinoff.nasa.gov/Spinoff2017/cg_1.html), with the aim of attacking the low end market with cheap and very low consumption sensors with tolerable image quality.
...
The commercial boom of artificial retinas however only began in 1998 with a much less ambitious application: the Game Boy Camera, equipped with the first mass-produced unit, the M64282FP sensor. The fate of the artificial retina series (M6428X) is then lost in more or less mass-marketed products, and they have _probably_ equipped Japanese cell phones, consumer multimedia products, fingerprint readers and security cameras. It is almost certain that the M64283FP sensor equipped the [“LaPochee” camera module](https://time-space.kddi.com/ketaizukan/1999/11.html) accompanying [the THZ43 Chiaro cell phone by Mitsubishi](https://time-space.kddi.com/ketaizukan/1999/10.html), which is technically the first mobile phone with (nearly an embedded) camera. Two capture modes were proposed: [1bpp "manga mode" or 4bbp "real mode", 96x96 pixels](https://pc.watch.impress.co.jp/docs/article/990413/tu_ka.htm). According to Mitsubishi, the M64283FP also probably equipped the [PCPICO](https://web.archive.org/web/20020925132513/http://pcpico.com/), a kind of easy-to-use-for-kids-and-elders multimedia interface in which the sensor was probably used as cheap digital camera (the scarse online documentation is all but clear about what the retina was used for, it's not really advertised). Sales figures for the “LaPochee” + THZ43 Chiaro were considered as unsatisfactory. Sales figures for the PCPICO are totally unknown (which probably means they were _very_ unsatisfactory). To date, none of these two devices have been disassembled to certify what sensor was into.
