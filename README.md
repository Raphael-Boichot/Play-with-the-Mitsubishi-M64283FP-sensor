...
The first commercial solid state camera, the [Cromemco Cyclops](https://en.wikipedia.org/wiki/Cromemco_Cyclops) issued in 1975, was created with the [first affordable MOS light sensitive sensor](/Pictures%20and%20datasheets/Popular%20Electronics-1975-02.pdf) comprising 32x32 pixels only. During the 80s, digital sensors progressively gained in quality and definition and the Charge Coupled Device or [CCD technology](https://en.wikipedia.org/wiki/Charge-coupled_device), with power hungry and expensive sensors producing good quality images, took the lead of the incipient digital imaging market. On the other hand, the Complementary Metal–Oxide–Semiconductor or [CMOS technology](https://en.wikipedia.org/wiki/CMOS), with sensors plagued with image artifacts, was relegated to the background. The development of CMOS-based image sensors for commercial applications only began in the early 90s, impulsed by the [NASA Jet Propulsion Laboratory](https://spinoff.nasa.gov/Spinoff2017/cg_1.html), with the aim of directly competiting the CCD technology with cheap and low-consumption sensors.
...
To overcome this weakness, the sensors in the artificial retina series evolved towards random tile addressing and projection to reduce the flow rate of pixels to convert (M64283FP) and lower definition (the M64285FP with 32x32 pixels matrix, is _theoretically_ able to output 5000 fps), but eventually disappeared in favor of faster, fully digital and color sensors. There is no official documentation available explaining which exact artificial retina equipped with exact device. The Game Boy Camera is no exception, except that it was oftenly dismantled since. The M64282FP itself being probably Nintendo Exclusive, it is safe to assume that any alledged 128x128 pixels artificial retina "not used in a Game Boy Camera" was a M64283FP. To date, none "Lapochee" or PCPICO have been disassembled and documented publically to confirm.
